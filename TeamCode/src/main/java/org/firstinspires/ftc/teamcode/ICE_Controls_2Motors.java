...
/**
 * Created by Team ICE 6340 on 10.19.2019!
 */


public abstract class ICE_Controls_2Motors extends LinearOpMode {
    ...
    //Instantiate servos
    //protected Servo ????;
    protected Servo leftServo5;
    protected Servo rightServo4;

    //Instantiate sensors
    //ColorSensor ?????;

    //Initlize encoder variables
    protected double COUNTS_PER_MOTOR_DRIVE = 560;    // Rev Hex Motor 288
    protected double COUNTS_PER_MOTOR_LIFT = 560;    // andyMark 40
    ...
    static final double COUNTS_PER_MOTOR_REV_CORE_HEX = 288;    // eg: Rev Core Hex Motor Encoder
    ...
    protected void initializeHardware() {
        ...
        leftServo5 = hardwareMap.get(Servo.class, "leftServo5");
        rightServo4 = hardwareMap.get(Servo.class,"rightServo4");
        //Initialize sensors
...
//Ensure the motors are in the right configuration
    ...
    private boolean onHeading(double speed, double angle, double PCoeff) {
        ...
        leftDrive(leftFrontSpeed);
        rightDrive(rightBackSpeed);
